...
Exploratory data analysis (EDA) is important step to be conducted in any data analysis project for, especifically for identification, and characterization of different features.
